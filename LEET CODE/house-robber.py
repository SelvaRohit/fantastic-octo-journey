...
class Solution(object):
    def rob(self, nums):
        ...
        :type nums: List[int]
        :rtype: int
        This recursion logic failed at 57th use case with size of input
        array of 96 because of Time Limit Exceeds in LeetCode.
        To solve this, we have to include memoization logic. 
        """
